<template>
  ...
  <div class="bg-white p-2 rounded-sm">
    <div class="p-2">
      <el-button  plain v-if="hasAuthBtn('/admin/v6_0_0/subSystem/save')" type="primary" :icon="CirclePlus" class="!ml-0"
        @click="handleAdd">添加
      </el-button>
      <el-button  plain v-if="hasAuthBtn('/admin/v6_0_0/subSystem/delete')" type="danger" :icon="Delete"
    ...
    <div>
      <el-table :data="pageInfo.table" border style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="partName" label="子系统名称" align="center" />
        <el-table-column prop="createDate" label="创建时间" />
        <el-table-column label="操作" width="80" align="center">
          <template #default="scope">
            <el-tooltip v-if="hasAuthBtn('/admin/v6_0_0/subSystem/update')" class="box-item" effect="dark" content="编辑"
              placement="top-start">
...
import { getList, delItem } from "@/api/system/subSystem";
